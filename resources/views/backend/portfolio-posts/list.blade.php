...
@section('content')
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="{{ route('portfolio-post-details.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @forelse ($details as $detail)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('portfolio-post-details.edit', $detail->id) }}"
                                            class="btn btn-sm btn-info">
                                            Edit
                                        </a>
                                        <form action="{{ route('portfolio-post-details.destroy', $detail->id) }}"
