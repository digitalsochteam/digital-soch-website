...
(function ($) {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        window.addEventListener("load", function () {
            ...
            var lgherot1 = gsap.timeline({
                defaults: { duration: 1, ease: "Back.easeOut" }, //
            });

            lgherot1.from(".lg-hero-slideup-1 ", {
                yPercent: 100,
                stagger: 0.1,
                delay: 0.3,
            });
            ...
            lgherot2.from(".lg-hero-1-plug ", {
                xPercent: 100,
                stagger: 0.1,
                delay: 1.5,
            });
            lgherot2.from(
                ".lg-hero-1-plug-single",
                { scale: 0, stagger: 0.1 },
                "<=.2"
            );
    ...
    var lgherofeature = gsap.timeline({
        ...
        defaults: { duration: 1.2, ease: "Back.easeOut" },
    });

    lgherofeature.from(".lg-h1-f-slide-right", {
        xPercent: -100,
        opacity: 0,
        stagger: 0.2,
    });
